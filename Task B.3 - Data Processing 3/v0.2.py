...
def load_and_process_data(ticker, start_date, end_date, features=['Open', 'High', 'Low', 'Close', 'Volume'],
    ...
    data_directory = os.path.expanduser(
        '~/Desktop/COS30018 - Intelligent Systems/Assignment_B/Task B.3 - Data processing 2')
...
predicted_prices = scalers['Close'].inverse_transform(
    predicted_prices)  # Inverse transform to get the original price scale.
